...
#  #('3J_mbpjet_vs_maxmjet_wrong', 'Max M_{jet}', 'M_{b+jet}', 'A.U.'), Joseph added
#  #('4J_mbpjet_vs_maxmjet_wrong', 'Max M_{jet}', 'M_{b+jet}', 'A.U.') Joseph added
#]
#wrong_nschi_shapes = [
...
# Joseph added right = ['Correct_Disc_Plots']
# Joseph added wrong = ['Wrong_Disc_Plots']
