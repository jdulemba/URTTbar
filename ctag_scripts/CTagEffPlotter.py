...
variables = [
    ...
    ("Wjets_DeepCSVCvsL", "DeepCSV CvsL Disc (W Jet)", 1, (0,1), False),
    ("Wjets_DeepCSVCvsB", "DeepCSV CvsB Disc (W Jet)", 1, (0,1), False),
    ...
    ("Wjets_DeepJetCvsL", "DeepJet CvsL Disc (W Jet)", 1, (0,1), False),
    ("Wjets_DeepJetCvsB", "DeepJet CvsB Disc (W Jet)", 1, (0,1), False),
...
preselection = [
    ("njets"	 , "# of selected jets", range(13), None, False),
    ("jets_DeepCSVCvsB", "DeepCSV CvsB Disc", 1, (0,1), False),
    ("jets_DeepCSVCvsL", "DeepCSV CvsL Disc", 1, (0,1), False),
    ...
    ("jets_DeepJetCvsB", "DeepJet CvsB Disc", 1, (0,1), False),
    ("jets_DeepJetCvsL", "DeepJet CvsL Disc", 1, (0,1), False),
