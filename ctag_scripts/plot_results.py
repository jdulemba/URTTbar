...
plt.tight_layout()
#set_trace()
fname1 = '%s%s_SF_stat_uncs_results' % (out_dir, dir_name)
...
plt.tight_layout()
#set_trace()
fname2 = '%s%s_SF_sys_uncs_results' % (out_dir, dir_name)
...
plt.grid()
plt.tight_layout()
fname3 = '%s%s_SF_stat_uncs_indiv_results' % (out_dir, dir_name)
...
plt.grid()
plt.tight_layout()
fname4 = '%s%s_SF_sys_uncs_indiv_results' % (out_dir, dir_name)
...
#plt.grid()
#plt.tight_layout()
#fname6 = '%s%s_SF_both_uncs_indiv_results' % (out_dir, dir_name)
