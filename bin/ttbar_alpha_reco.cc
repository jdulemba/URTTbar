...
class ttbar_final_reco_3J : public AnalyzerBase
{
            ...
            mc_weights_()
    {
        ...
        void fill_post_alpha_correction_plots( string folder, GenTTBar &ttbar, Permutation &perm ){
            ...
            reco_mass_dir->second["Reco_vs_Gen_TTbar_Corrected"].fill( ttbar.M(), (Alpha_THad + perm.TLep()).M() );
            ...
            reco_costh_dir->second["Reco_vs_Gen_THad_Corrected"].fill( gen_cosths.first, reco_corr_thad_cth );
            ...
            reso_mass_dir->second["Reso_MTTbar_vs_Gen_MTTbar_Corrected"].fill( ttbar.M(), ttbar.M() - (Alpha_THad + perm.TLep()).M() );
            ...
            reso_mass_dir->second["Frac_TTbar_vs_Gen_THadPt"].fill( ttbar.had_top()->Pt(), (ttbar.M() - perm.LVect().M())/ttbar.M() );
            reso_mass_dir->second["Frac_TTbar_vs_Gen_THadPt_Corrected"].fill( ttbar.had_top()->Pt(), (ttbar.M() - (Alpha_THad + perm.TLep()).M())/ttbar.M() );

                    // reso breaking up by number of partons in acceptance
                        // combined categores
            reso_part_dir->second["Reso_MTTbar_All"].fill( ttbar.M() - perm.LVect().M() );
            reso_part_dir->second["Reso_MTTbar_vs_Gen_MTTbar_All"].fill( ttbar.M(), ttbar.M() - perm.LVect().M() );
            reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_All"].fill( ttbar.had_top()->Pt(), (ttbar.M() - perm.LVect().M())/ttbar.M() );

            reso_part_dir->second["Reso_MTTbar_All_Corrected"].fill( ttbar.M() - (Alpha_THad + perm.TLep()).M() );
            reso_part_dir->second["Reso_MTTbar_vs_Gen_MTTbar_All_Corrected"].fill( ttbar.M(), ttbar.M() - (Alpha_THad + perm.TLep()).M() );
            reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_All_Corrected"].fill( ttbar.had_top()->Pt(), (ttbar.M() - (Alpha_THad + perm.TLep()).M())/ttbar.M() );
            ...
            if( ttbar.two_partons_in_acceptance(30., 2.4) ){
                ...
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_2Partons"].fill( ttbar.had_top()->Pt(), (ttbar.M() - perm.LVect().M())/ttbar.M() );

                reso_part_dir->second["Reso_MTTbar_2Partons_Corrected"].fill( ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Reso_MTTbar_vs_Gen_MTTbar_2Partons_Corrected"].fill( ttbar.M(), ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_2Partons_Corrected"].fill( ttbar.had_top()->Pt(), (ttbar.M() - (Alpha_THad + perm.TLep()).M())/ttbar.M() );
            }
            if( ttbar.three_partons_in_acceptance(30., 2.4) ){
                ...
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_3Partons"].fill( ttbar.had_top()->Pt(), (ttbar.M() - perm.LVect().M())/ttbar.M() );

                reso_part_dir->second["Reso_MTTbar_3Partons_Corrected"].fill( ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Reso_MTTbar_vs_Gen_MTTbar_3Partons_Corrected"].fill( ttbar.M(), ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_3Partons_Corrected"].fill( ttbar.had_top()->Pt(), (ttbar.M() - (Alpha_THad + perm.TLep()).M())/ttbar.M() );
            }
            if( ttbar.all_partons_in_acceptance(30., 2.4) ){
                ...
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_4Partons"].fill( ttbar.had_top()->Pt(), (ttbar.M() - perm.LVect().M())/ttbar.M() );

                reso_part_dir->second["Reso_MTTbar_4Partons_Corrected"].fill( ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Reso_MTTbar_vs_Gen_MTTbar_4Partons_Corrected"].fill( ttbar.M(), ttbar.M() - (Alpha_THad + perm.TLep()).M() );
                reso_part_dir->second["Frac_MTTbar_vs_Gen_THadPt_4Partons_Corrected"].fill( ttbar.had_top()->Pt(), (ttbar.M() - (Alpha_THad + perm.TLep()).M())/ttbar.M() );
            }
        ...
        virtual void analyze()
        {
            ...
            while( event.next() )
            {
                if(evt_idx_ % 10000 == 0) Logger::log().debug() << "Beginning event " << evt_idx_ << " eventnumber: " << event.evt << endl;
                ...
                auto njets_dir = histos_.find("njets");
                njets_dir->second["njets"].fill(njets);
