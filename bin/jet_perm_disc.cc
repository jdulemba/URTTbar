...
class jet_perm_disc : public AnalyzerBase
{
            ...
            mc_weights_()
    {
        ...
        virtual void begin()
        {
            ...
            //
            //            // Likelihood Discriminant
            //        t13 = new TTree("MassDiscr_3J", "Tree with likelihood discriminant 3J.");
            //        t13->Branch("MassDiscr_3J", &Merged3JDiscr_3J, "Merged3JDiscr_3J/D");
        ...
        Permutation process_3J_evt(URStreamer &event){
            ...
            for( auto test_perm : permutator_.permutations_3J(wj1, wj2, bj1, bj2, object_selector_.lepton(), object_selector_.met(), object_selector_.lepton_charge()) ){
                ...
                if( test_perm.MassDiscr() < lowest_massdisc_3J ){
                    lowest_massdisc_3J = test_perm.MassDiscr();
                    //                best_perm = test_perm;
                }
                like_dir->second["3J_Event_All_Massdisc"].fill(test_perm.MassDiscr()); // all perm disc values
            ...
            if( !best_perm.IsEmpty() ){
                ...
                like_dir->second["3J_Event_Best_Perm_Massdisc"].fill(best_perm.MassDiscr()); // best perm perm disc value
        ...
        void likelihood_3J_calc(URStreamer &event){
            ...
            if( !(ttbar.type == GenTTBar::DecayType::SEMILEP) ){ // skip to next event if perm is empty
                like_dir->second["3J_Best_Perm_WRONG_Massdisc"].fill(best_perm.MassDiscr());
            ...
            if( matched_perm.Merged_Event() ){ // matched perm has merged objets
                ...
                if( matched_perm.AreBsSame(best_perm) && ( best_perm.WJa() == matched_perm.WJa() || best_perm.WJa() == matched_perm.WJb() ) ){ 
                    like_dir->second["3J_Best_Perm_RIGHT_Massdisc"].fill(best_perm.MassDiscr());
                ...
                // objects in best_perm and matched_perm are the same but in differnt orders
                    ...
                    like_dir->second["3J_Best_Perm_MERGE_SWAP_Massdisc"].fill(best_perm.MassDiscr());
                ...
                // objects in best_perm and matched_perm are not all the same
                    ...
                    like_dir->second["3J_Best_Perm_MERGE_Massdisc"].fill(best_perm.MassDiscr());
