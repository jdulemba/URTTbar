...
public:
  ...
  ctag_eff(const std::string output_filename):
    ...
    wp_SFs_["cmvaLoose" ] = BTagSFProducer(cmva_sfs, wjet_efficiency, IDJet::BTag::CTAGLOOSE , IDJet::BTag::NONE, 0.5, -1, -1); 
    wp_SFs_["cmvaTight" ] = BTagSFProducer(cmva_sfs, wjet_efficiency, IDJet::BTag::CTAGTIGHT , IDJet::BTag::NONE, 0.5, -1, -1); 
    wp_SFs_["cmvaMedium"] = BTagSFProducer(cmva_sfs, wjet_efficiency, IDJet::BTag::CTAGMEDIUM, IDJet::BTag::NONE, 0.5, -1, -1); 
