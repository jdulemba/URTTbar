...
parser.add_argument('--plot', help='Choose type of plots to generate (Gen, Reconstruction, Resolution, Discriminant, Alpha_Correction, Post_Alpha, All).')
...
def Final_Reco_Plots( plot ):
    ...
    if plot == 'Gen':
        ...
        Gen_Plots( reco_dir , reco_subdir, classes )
    ...
    if plot == 'Alpha_Correction':
        ...
        alpha_corrections( reco_dir , reco_subdir, classes )
...
if args.perm == 'Event':
    if args.plot == 'All':
        ...
        Final_Reco_Plots('Alpha_Correction')
        Final_Reco_Plots('Post_Alpha')
    else:
